-- Schema comercial complementar para produto-comercial-restaurantes.
-- ATENCAO: o estoque atual usa backend/supabase_inventory_schema.sql.
-- Este arquivo fica como referencia para etapas futuras de delivery/fiscal e nao deve
-- ser aplicado em producao sem revisao das rotas correspondentes.
